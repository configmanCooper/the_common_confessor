const FAMILIES = [
  ...
  ["false_charity", ["village concern", "private counsel"], "A household receives church food while hiding full grain bins.", "The deception is draining aid from families in true need.", "Protect vulnerable members, verify the stores, and revise aid only after the household is heard."],
  ...
  ["midwife_error", ["grave conscience", "private counsel"], "A birth went badly, and the midwife concealed a serious mistake.", "The grieving family blames divine punishment instead of negligence.", "Preserve the medical evidence, protect the grieving household, and decide how the truth and restitution should be handled."],
  ["healer_secret", ["private counsel", "decision"], "A healer knows a popular remedy is ineffective but continues selling it.", "Desperate families spend scarce coin while real treatment is delayed.", "Stop presenting the remedy as proven, compare patient outcomes, and arrange repayment or alternative care."],
  ...
  ["feast_store_theft", ["village concern", "decision"], "Food reserved for a holy-day feast has disappeared.", "{victim} is blamed because of an old reputation for theft.", "Audit the storehouse keys and accounts, secure replacement food if possible, and accuse no one until evidence distinguishes theft from error."],
